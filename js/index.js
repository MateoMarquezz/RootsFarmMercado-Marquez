...
//Botón para mostrar el menú para armar bolson personalizado
$('.armar-bolson').click((e) => {
    $('.stock-modal').fadeIn('slow');
})

//Carrito

//Muestro el carrito cuando hago HOVER sobre imagen carrito:
...
$('#checkout-shippinginfo-div :input').change((e) => {
        if (e.target.dataset.shipping == 'true') { //si se rquiere envío:
            ...
            $('#checkout-shipping-notes').attr("placeholder", "Cómo encontrar tu casa...")
            updateCheckoutAmount(); //Actualizo los importes a abonar, en variables y en DOM
